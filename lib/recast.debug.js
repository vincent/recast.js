...
// end include: src/plugins/flock.js
// include: src/plugins/formation.js
/* global recast */
...
// end include: src/plugins/formation.js
...
var findStringEnd = (heapOrArray, idx, maxBytesToRead, ignoreNul) => {
  ...
  function _recast_build_callback(navmeshTypePtr) {
  ...
  function _recast_path_callback(callback_id, dataPtr, count) {
        const path = [];
  ...
  function _recast_update_callback(callback_id) {
        Module.__RECAST_CALLBACKS[callback_id](agentPoolBuffer);
      }

  function _recast_vector_callback(callback_id, x, y, z) {
...
var wasmImports = {
  ...
  js_set_debug_data,
  /** @export */
  recast_build_callback: _recast_build_callback,
  /** @export */
  recast_file_callback: _recast_file_callback,
  /** @export */
  recast_generic_callback_string: _recast_generic_callback_string,
  /** @export */
  recast_log_callback: _recast_log_callback,
  /** @export */
  recast_path_callback: _recast_path_callback,
  /** @export */
  recast_update_callback: _recast_update_callback,
  /** @export */
  recast_vector_callback: _recast_vector_callback
};
