...
CFLAGS = -O2 --closure 1 -g -s WARN_ON_UNDEFINED_SYMBOLS=0 -s VERBOSE=0 -s NO_EXIT_RUNTIME=1 -s LINKABLE=1 -s ALLOW_MEMORY_GROWTH=0 -s DISABLE_GL_EMULATION=1 -s DISABLE_EXCEPTION_CATCHING=1 -s ASSERTIONS=0 -s TOTAL_MEMORY=200331648 --bind
