...
CFLAGS = --closure 1 -O2 -g -s WARN_ON_UNDEFINED_SYMBOLS=0 -s NDEBUG=1 -s NO_EXIT_RUNTIME=1 -s LINKABLE=1 -s ALLOW_MEMORY_GROWTH=1 -s DISABLE_GL_EMULATION=1 -s DISABLE_EXCEPTION_CATCHING=0 -s ASSERTIONS=1 --bind
